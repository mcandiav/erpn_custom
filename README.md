...
**Estado:** `16.0.29` — `extend_bootinfo` filtra Desktop Icons para ComercialFRA; JS mínimo redirige `/desk`. Workspace sin module en site. Pendiente aceptación operativa (smoke webhook `16.0.29`).
